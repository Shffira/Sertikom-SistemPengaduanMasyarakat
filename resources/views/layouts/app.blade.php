...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white shadow-md flex flex-col justify-between flex-shrink-0">
        ...
        <div>
            ...
            <nav class="mt-4 px-4 space-y-1">
                ...
                @if(auth()->user()->role === 'admin')
                    ...
                    <a
                        href="{{ route('complaints.index', ['status' => 'pending']) }}"
                    ...
                    <a
                        href="{{ route('complaints.index', ['status' => 'selesai']) }}"
                    ...
                    >
                        ...
                        <i class="fa fa-check-circle w-4"></i>
                ...
                @else
                    ...
                    >
                        ...
                        <i class="fa fa-plus-circle w-4"></i>
        ...
        <div class="px-4 py-4 border-t">
            ...
            >
                ...
                <button
                    ...
                    class="flex items-center gap-3 px-4 py-2.5 w-full text-sm text-gray-600 hover:bg-gray-100 rounded-lg transition"
                >
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header
            class="bg-white shadow-sm px-6 py-4 flex items-center justify-between flex-shrink-0"
        >
